...
enum TowerGunFactory {
    ...
    static func makeAssembly(for type: TowerType) -> Assembly {
        ...
        case .blue:
            ...
            muzzle.zPosition = 4
            aimNode.addChild(muzzle)

            tipOffset = CGPoint(x: 0, y: 33)
        }

        return Assembly(aimNode: aimNode, tipOffset: tipOffset)
    }
}
